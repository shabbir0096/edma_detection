...
class _GalleryScreenState extends State<GalleryScreen> {
  ...
  void resultEdema(String key , double value) async {
    ...
    try {
      ...
      if(value == 0.00){
        alertBox(
            "Result",
            "Congratulation! No Edema detected",
            AlertType.success,
            "Ok", () {
              Get.back();
        }, () {
        ...
        alertBox(
            "Result",
            "Kindly Contact to doctor for better treatment.",
            AlertType.warning,
            "Ok", () {
          Get.back();
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => const DoctorsPageView(),
            ),
          );
        }, () {
          Get.back();
  ...
  Future<void> processImage() async {
    if (imagePath != null) {
      ...
      print("classification in flutter $classification");
